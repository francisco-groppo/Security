...
public class JwtTokenUtil implements Serializable {
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        authServiceRedis.store(subject, token);
    ...
    public Boolean validateToken(String token, UserDetails userDetails, HttpServletRequest request) {
        ...
        Optional<Authentication> authentication = this.authServiceRedis.authenticate(username, request);
